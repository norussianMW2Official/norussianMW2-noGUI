...
int __attribute__((constructor)) norussianMW2Init()
{
	...
	cvar->ConsoleColorPrintf(ColorRGBA(150, 255, 150), "norussianMW2 was successfully injected.\n");
...
void __attribute__((destructor)) norussianMW2Shutdown()
{
	...
	*(CamThinkSvCheatsCheck + 0x1) = 0x64;
	...
	cvar->ConsoleColorPrintf(ColorRGBA(255, 150, 150), "norussianMW2 has been unloaded successfully.\n");
}
