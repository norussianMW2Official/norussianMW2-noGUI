...
SDL_GLContext norussianMW2_context = nullptr;
...
void SDL2::SwapWindow(SDL_Window* window)
{
	...
	if (!norussianMW2_context)
	{
		norussianMW2_context = SDL_GL_CreateContext(window);
	...
	SDL_GL_MakeCurrent(window, norussianMW2_context);
...
void SDL2::UnhookWindow()
{
	*swapWindowJumpAddress = oSwapWindow;
	...
	SDL_GL_DeleteContext(norussianMW2_context);
}
